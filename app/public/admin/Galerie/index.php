        ...
        <ul class="flex flex-col gap-5 items-center justify-center my-5">
            <div class="flex gap-5 ">
                <a class="my-5 p-5 border-4 border-red-600 bg-white rounded-lg hover:bg-yellow-200 western"
                    href="/admin/Galerie/addElementsGalerie.php">Ajouter des images</a>
                <a class="my-5 p-5 border-4 border-red-600 bg-white rounded-lg hover:bg-yellow-200 western"
                    href="../index.php">Retour</a>
            </div>

            <?php if (empty($images)): ?>
                <li class="western text-center text-2xl font-bold border-2 border-red-600 rounded-lg bg-white p-2">Aucune
                    image trouvée</li>
            <?php endif; ?>
            <?php foreach ($images as $image): ?>
                <li
                    ...
                    <a class="p-5 border-4 border-red-600 bg-white rounded-lg hover:bg-yellow-200 western"
                        href="/admin/Galerie/deleteElementsGalerie.php?id=<?= $image['id'] ?>">Supprimer</a>
                </li>
            <?php endforeach; ?>
        </ul>
    </main>
